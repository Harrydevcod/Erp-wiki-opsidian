...
### e-Fatura OAuth local

Se for usar a integracao OAuth da e-Fatura localmente, preencha tambem `.env.functions`:

- `ENCRYPTION_KEY`
- `APP_URL=http://localhost:8080`
- `EFATURA_REDIRECT_URI=http://127.0.0.1:54321/functions/v1/efatura-oauth-callback`

Depois registe essa callback URI na DNRE e faca deploy local das Edge Functions:
...
- Para a e-Fatura, a callback passa pelo endpoint `efatura-oauth-callback` nas Edge Functions e nao pela rota frontend antiga.
