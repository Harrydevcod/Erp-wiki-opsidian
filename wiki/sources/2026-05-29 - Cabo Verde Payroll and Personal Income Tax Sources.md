...
- Progressive rates: the exact withholding scale is now captured from primary law — the **IUR-era** [[2013-01-10 - Portaria 5-2013 Retencao IUR Trabalho Dependente]] gives marginal rates **11.67% / 15.56% / 21.39% / 27.22% / 35%** with parcelas a abater and an `α` family-charges table. The earlier secondary figures (16.5–27.5% / a 0–27% table) are superseded by this primary source; the remaining unknown is whether the IRPS-era regime changed these rates (see [[Contradiction - IRPS Category A Withholding Brackets]]).
