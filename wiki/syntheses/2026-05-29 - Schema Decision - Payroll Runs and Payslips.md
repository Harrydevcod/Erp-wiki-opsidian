...
- Subsidies/overtime (Código Laboral, captured provisionally in [[2026-05-29 - Cabo Verde Payroll and Personal Income Tax Sources]]): normal time **8h/day, 44h/week**; **overtime** capped 2h/day·160h/yr (300h with consent), rate **disputed +35% vs +50%** (verify vs DL 1/2016) — model as a configurable multiplier, tiered for rest-days/holidays; **night work 22h–06h at +25%**; **férias 22 dias úteis/yr**. The **subsídio de Natal/13.º** formula is still uncaptured (CV-specific). Each modeled as a rule-versioned component with `legal_source_ref = Código Laboral / DL 1/2016`.
