...
- [[Contradiction - IRPS Category A Withholding Brackets]] - Resolved for the IUR era by primary law (Portaria 5/2013: 11.67%–35% scale); remaining unknown is whether the IRPS-era regime changed the rates.
...
- Payroll/asset legal sources captured ([[2013-01-10 - Portaria 5-2013 Retencao IUR Trabalho Dependente]] gives the primary withholding formula/scale; [[2026-05-29 - Cabo Verde Payroll and Personal Income Tax Sources]], [[2026-05-29 - Cabo Verde Depreciation and Amortization Sources]]). Remaining: confirm the current IRPS-era withholding portaria vs the IUR-2013 scale, the Mínimo de Existência value and INPS ceiling, the Código Laboral subsidy/overtime formulas, and the Portaria 42/2015 per-class depreciation rate annex (PDF is non-machine-readable — needs OCR/manual pass).
