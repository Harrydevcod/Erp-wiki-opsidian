...
- Payroll/asset legal sources captured from primary law: withholding formula/scale ([[2013-01-10 - Portaria 5-2013 Retencao IUR Trabalho Dependente]], [[2008-12-29 - Tabela de Retencao IUR 2009]]) and the full depreciation regime ([[2015-08-24 - Portaria 42-2015 Depreciacoes e Amortizacoes]]). Resolved: the IRPS withholding regime is now anchored in **primary law** ([[2015-01-23 - Decreto-Lei 6-2015 Regime de Retencoes na Fonte IRPS]]) — monthly Category A formula 15/21/25% with parcela 5.500/10.300/16.300, superseding the IUR scale. **Still to obtain:** the DL 6/2015 retificação check + OE-year re-indexing of the 80.000$/150.000$ thresholds, the Mínimo de Existência value, the INPS contribution-base floor/cap, and the **Código Laboral** overtime rate (**+35% vs +50% dispute**) and subsídio de Natal/13.º formula (working-time/night/leave parameters now captured provisionally in [[2026-05-29 - Cabo Verde Payroll and Personal Income Tax Sources]]). The **per-class depreciation rate annex** of Portaria 42/2015 is now captured ([[Portaria 42-2015 Tabelas de Taxas de Depreciacao]]).
