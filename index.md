...
- Payroll/asset legal sources captured from primary law: withholding formula/scale ([[2013-01-10 - Portaria 5-2013 Retencao IUR Trabalho Dependente]], [[2008-12-29 - Tabela de Retencao IUR 2009]]) and the full depreciation regime ([[2015-08-24 - Portaria 42-2015 Depreciacoes e Amortizacoes]]). Remaining: confirm the current **IRPS-era** withholding portaria vs the IUR scale, the Mínimo de Existência value and INPS ceiling, the Código Laboral subsidy/overtime formulas, and the **per-class depreciation rate annex** (not in the supplied PDF).
